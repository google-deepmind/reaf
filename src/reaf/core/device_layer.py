...
"""REAF device layer to interface with the robotic setup."""
...
class DeviceLayer:
  ...
  The device layer is responsible to provide an interface for the robotic setup.
  """
  ...
  def _get_measurements(self) -> Mapping[str, gdmr_types.ArrayType]:
    """Gets the measurements of the device layer."""
    measurements = {}
